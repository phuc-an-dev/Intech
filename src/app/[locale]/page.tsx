        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-16">
            ...
            >
              ...
              <p className="text-gray-600">
                {t("featured_courses.description")}
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 20 }}
                ...
                {[
                  {
                    ...
                    title: t("why_choose_us.item1_title"),
                    desc: t("why_choose_us.item1_desc")
                  },
                  {
                    icon: <Globe className="w-6 h-6 text-white" />,
                    title: t("why_choose_us.item2_title"),
                    desc: t("why_choose_us.item2_desc")
                  },
                  {
                    icon: <Users className="w-6 h-6 text-white" />,
                    title: t("why_choose_us.item3_title"),
                    desc: t("why_choose_us.item3_desc")
                  },
                  {
                    icon: <MonitorPlay className="w-6 h-6 text-white" />,
                    title: t("why_choose_us.item4_title"),
                    desc: t("why_choose_us.item4_desc")
                  }
                ].map((item, idx) => (
